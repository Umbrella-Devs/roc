    ...
    <div>
        <div class="bg">
            <div class="w-100 flex">
                <div class="w-45 mx-auto mt-24 text-black px-5 py-5 rounded bg-black opacity-75" data-aos="fade-down" data-aos-duration="1500">
                    <div class="text-centered text-white">
                        <h1 class="pb-3 text-3xl">What We Do</h1>
                        <p class="">Our 5 years of successful conservation work in  educating the next generation of scientists and conservationists in Africa so that communities can thrive and work together with us.</p>
                    </div>
        ...
        <div>
            <div class="w-80 mx-auto mb-5 text-grey-darkest" id="activities">
                <div class="text-centered py-5">
                    <h2 class="text-3xl py-5">Our Activities</h2>
                </div>
                <div class="w-100 flex mb-5">
                    <div class="w-45 mb-5" data-aos="fade-right" data-aos-duration="1500">
                        <v-img class="" src="/img/IMG_4694.jpg"></v-img>
                    </div>
                    <div class="w-50 mx-auto mt-12 text-grey-darkest" data-aos="fade-left" data-aos-duration="1500">
                        <div class="pl-5">
            ...
            <div class="w-100 py-5 bg-white"> 
                <div class="w-80 mx-auto py-5">
                    ...
                    <div class="w-50 mt-12">
                        <div class="text-grey-darkest" data-aos="fade-right" data-aos-duration="1500">
                    ...
                    <div class="w-45" style="" data-aos="fade-left" data-aos-duration="1500">
            ...
            <div class="w-100 py-5">
                <div class="w-80 py-5 mx-auto">
                    <div class="w-100 flex mb-5">
                    <div class="w-45" data-aos="fade-right" data-aos-duration="1500">
                        <v-img class="" src="/img/IMG_1734.jpg"></v-img>
                    </div>
                    <div class="w-50 mx-auto mt-12 text-grey-darkest" data-aos="fade-left" data-aos-duration="1500">
                        <div class="pl-5">
                            <h2 class="text-2xl">Research </h2>
            ...
            <div class="w-100 py-5 bg-white"> 
                <div class="w-80 mx-auto py-5">
                    <div class="w-100 flex">
                    <div class="w-50 mt-12" data-aos="fade-right" data-aos-duration="1500">
            ...
            <div class="w-100 py-5">
                <div class="w-80 mx-auto py-5">
                    ...
                    <div class="w-50 mx-auto mt-12  text-grey-darkest" data-aos="fade-left" data-aos-duration="1500">
                        <div class="pl-5">
                            <h2 class="text-2xl">Daily Protection</h2>
