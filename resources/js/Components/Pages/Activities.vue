    ...
    <div>
        <div class="bg">
            <div class="w-100 flex">
                <div class="w-45 mx-auto mt-24 text-black px-5 py-2 rounded bg-black opacity-75">
        ...
        <div>
            <div class="w-80 mx-auto mb-5" id="activities">
                <div class="text-centered my-5">
                    <h2 class="p-5">Our Activities</h2>
                </div>
                <div class="w-100 flex mb-5">
                    ...
                    <div class="w-50 mx-auto mt-12 text-grey-darkest">
                        ...
                        <div class="text-centered">
                            <button class="btn bg-orange-dark text-white">View More</button>
                        </div>
                    </div>
                </div> 
            </div>
            ...
            <div class="w-100 py-4">
                <div class="w-80 mx-auto">
                    ...
                    <div class="w-50 mx-auto mt-12  text-grey-darkest">
                        ...
                        <div class="text-centered">
                            <button class="btn shadow-sm bg-orange text-white">View More</button>
                        </div>
                    </div>
                </div>
                </div>
